<template>
    <div class="index">
        ...
        <image class="inv" src="../../static/images/inv1.png"/>
        ...
        <div class="info" :animation="animationData">
            <div class="content" :model="wedding">
                <h1>{{wedding.title}}</h1>
                <p>{{wedding.content1}}</p>
                <p>{{wedding.content2}}</p>
                <p>{{wedding.content3}}</p>
                <p>{{wedding.content4}}</p>
...
export default {
  ...
  methods: {
    ...
    getMusicUrl () {
      ...
      wedding.get().then(res => {
        that.wedding = res.data[0]
      })
